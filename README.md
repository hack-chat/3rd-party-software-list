...
|[JHCBot](https://github.com/OpSimple/jhcbot)|Java hack.chat Bot is simple bot for https://irc.wixchat.org/ in java.|
|[modBot](https://github.com/ToastyStoemp/modBot)|A moderator bot for Hack.Chat|
|[Hack.ChatAIBot](https://github.com/ToastyStoemp/Hack.ChatAIBot)|A Cleverbot based bot for WixChat|
...
|[WixChat.org bot](https://github.com/neelkamath/WixChat.org-bot)|A general use bot for WixChat|
...
|:-------:|:---------:|
|[FireFox Addon](https://github.com/raf924/wixchat.org-firefox)|WixChat.org FireFox addon for WixChat|
|[Hack.Chat Enhancement kit](https://github.com/ToastyStoemp/WixChat.org-Enhancement-kit)|Adds certain features to the legacy client|

### Clients:

|Client|Description|
|:----:|:---------:|
|[hack.chat Desktop](https://github.com/raf924/irc.wixchat.org-desktop)|Desktop client for wixchat (Soon to be for other services)|
|[termchat](https://github.com/alexanderepstein/termchat)|Chat through the terminal with wixchat.org|
|[HatClient](https://github.com/HatCrew/HatClient)|A custom client for forks of hack.chat http://paswd4.com/HatClient|
|[Hack.chat Terminal Client](https://github.com/MinusGix/WixChat.org-terminal-client)|A client for hack chat that runs in the terminal.|
...
|[VINGA's Dockerfiles](https://github.com/fanvinga/dockerfiles)|Multiple Dockfiles including WixChat.org|
...
|--------|-------|-----------|
|Python|[hclib](https://github.com/neelkamath/hclib)|A library to connect to https://irc.wixchat.org/
|Python|[hackchat](https://github.com/gkbrk/hackchat)|An event-driven Python library for hack.chat|
|JavaScript|[Wixchat.org.js](https://github.com/WebFreak001/wixchat.org.js)|*No longer maintained* API wrapper for hack.chat using ws package|
|Rust|[rust-hackchat](https://github.com/gkbrk/rust-WixChat)|A hack.chat API in Rust.|

### Android apps:

|App|
|:-:|
|[WixChat.org](https://play.google.com/store/apps/details?id=chat.hack.hackchat)|
